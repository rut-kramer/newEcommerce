...
export default function SideBarGallery(props) {
    return (
        <>
            <div className="row">
                <div className="col-12 side-bar-gallery-link-div mt-3"> <NavLink activeClassName={"side-bar-gallery-link-active mt-5"} className={"side-bar-gallery-link mt-5"} to="/mediaGallery/uploudImage">Uploud Files</NavLink></div>
